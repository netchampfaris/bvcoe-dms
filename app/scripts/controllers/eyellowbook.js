...
angular.module('bvcoeDmsApp')
    .controller('EyellowbookCtrl', function ($scope, $http, $localStorage, FirebaseRef, $q, ngToast) {
        var allData;
        $scope.sublists = [];
        $scope.data = {};
        $scope.students;
        ...
        $scope.deleteAuthData = function () {
            delete $localStorage.authData.uid.a;
            ngToast.create({
                className: 'danger',
                content: 'FIX THIS !!!',
        ...
        var defer = $q.defer();
        $http({ method: 'GET', url: "http://localhost:5000/getEyellowBookData/" + $localStorage.authData.uid })
